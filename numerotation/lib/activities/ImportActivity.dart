...
import 'package:numerotation/activities/ImportExportActivity.dart';
...
class _ContactListPageState extends State<ContactListPage> {
  ...
  List<bool> selectionner = new List<bool>.filled(1000000, false, growable: true);
  List<Contact> contactSelectione=[];
            ...
            onPressed: (){
              ...
              Navigator.pushAndRemoveUntil(
                ...
                MaterialPageRoute(builder: (context) {
                  ...
                  return ImportExportActivity(contacts: contactSelectione,);
                }),
        ...
        child: _contacts != null
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            return ListTile(
              ...
              selected: selectionner[index],
              onTap: () {
                print("Selected");

                if(selectionner[index] == true)
                  {
                    setState(() {
                      selectionner[index] = false;
                      contactSelectione.remove(_contacts[index]);
                    });
                  }
                  ...
                  print("yoooo");
                  setState(() {
                    selectionner[index] = true;
                    contactSelectione.add(_contacts[index]);
                  });
                }


                print("taille: "+contactSelectione.length.toString());
